...
workspace = resolve(projectRoot, workspace).replace(projectRoot + '/', '')

const defaultRawEditOptions = {
  // pathList: [
...
const rawEditOptions = Object.assign({}, defaultRawEditOptions, vueScooterConfig.rawEditOptions || {})
